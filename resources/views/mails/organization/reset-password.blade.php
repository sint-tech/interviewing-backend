    ...
    <tr style="width:100%">
        <td>
            <table align="center" width="100%" data-id="react-email-section" style="padding:0 48px" border="0" cellPadding="0" cellSpacing="0" role="presentation">
                <tbody>
                <tr>
                    <td><img data-id="react-email-img" alt="Sint" src="{{secure_asset('assets/BlueLogo.png')}}" height="30" style="display:block;outline:none;border:none;text-decoration:none" />
                        <hr data-id="react-email-hr" style="width:100%;border:none;border-top:1px solid #eaeaea;border-color:#e6ebf1;margin:20px 0" />
                        <p data-id="react-email-text" style="font-size:16px;line-height:24px;margin:16px 0;color:#525f7f;text-align:left">Hello!</p>
                        <p data-id="react-email-text" style="font-size:16px;line-height:24px;margin:16px 0;color:#525f7f;text-align:left">You are receivina this email because we received a password reset request for your
                            account.<br> Please click the button below to reset your password</p><a href="{{$url}}" data-id="react-email-link" target="_blank" style="color:#fff;text-decoration:none;background-color:#0036ce;border-radius:5px;font-size:16px;font-weight:bold;text-align:center;display:block;width:100%;padding:10px 0">Reset Password</a>
                        <hr data-id="react-email-hr" style="width:100%;border:none;border-top:1px solid #eaeaea;border-color:#e6ebf1;margin:20px 0" />
