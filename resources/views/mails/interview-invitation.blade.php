    ...
    <tr style="width:100%">
        <td>
            <table align="center" width="100%" data-id="react-email-section" style="padding:0 48px" border="0" cellPadding="0" cellSpacing="0" role="presentation">
                <tbody>
                <tr>
                    <td><img data-id="react-email-img" alt="sint" src="{{asset('assets/BlueLogo.png')}}" width="85" height="37" style="display:block;outline:none;border:none;text-decoration:none" />
